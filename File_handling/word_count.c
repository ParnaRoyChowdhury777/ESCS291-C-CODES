...
int main()
{
        ...
        int binarySearch(int, int, char[], int max, char[][100]);
        void addToList(char[], int max, char[][100], int[], int, int);
        void printResults(FILE *, int max, char[][100], int[], int);
...
int binarySearch(int lo, int hi, char key[], int max, char list[][100])
{
...
void addToList(char item[], int max, char list[][100],
...
void printResults(FILE *out, int max, char list[][100], int freq[], int n)
{
        fprintf(out, "\nWords    Frequency\n\n");
        for (int h = 0; h < n; h++)
                fprintf(out, "%-15s %2d\n", list[h], freq[h]);
